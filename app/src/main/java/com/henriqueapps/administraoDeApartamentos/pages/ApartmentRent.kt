...
class ApartmentRent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.valueReal.text = "R$ ${String.format("%.2f", price.toDouble())}"
    ...
    private fun discountedValue(boolean: Boolean?) {
        ...
        if (boolean == true) {
            if (editDiscoutValue == 0.0){
                binding.discountedValue.text = "R$ ${String.format("%.2f", price.toDouble())}"
                ...
                binding.discountedValue.text = "R$ ${String.format("%.2f",(price.toDouble()) - editDiscoutValue)}"
            ...
            if (editDiscountPercentage.isEmpty()){
                ...
                binding.editDiscountValue.setText(String.format("%.2f",value))
                binding.discountedValue.text = "R$ ${String.format("%.2f",(price.toDouble()) - value)}"
